...
class PassMan(ttk.Frame):
    ...
    def logInNow(self):
        ...
        if database.readMasterPwd() == None:
            ...
            self.createSubLabel = ttk.Label(
                self.create, text="You must remember this password !\nIt will be used to encrypt all the other passwords !\nIt must be at least 8 characters long...", font="helvetica 12 italic", justify="center")
            ...
            self.createLabel.pack(padx=20, pady=(20, 0))
            self.createSubLabel.pack(padx=20, pady=(0, 20))
            ...
            self.createMasterPwdEntry.bind("<Return>", lambda event: self.createMasterPwd())
    ...
    def newPwdDisplay(self):
        ...
        self.generateNewPwdEntry.config(state="readonly", width=50)
        ...
        x = (self.generateNew.winfo_screenwidth() - 500) / 2
        y = (self.generateNew.winfo_screenheight() - 300) / 2
        self.generateNew.geometry("%dx%d+%d+%d" % (500, 350, x, y))
    ...
    def createMasterPwd(self):
        ...
        if len(self.createMasterPwdEntry.get()) < 8:
            ...
            messagebox.showinfo(
                ...
                title="Master Password successful")
            self.create.destroy()
